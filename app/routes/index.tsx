  ...
  return (
    <>
      ...
      <p>
        ...
        possible while at the same time providing a satisfying experience for
        the user. To get an idea of where I've worked, please check out my{' '}
